...
+----------------------+----------+---------------------+-----------------+---------------------+---------------+-----------+------------------------+-------+---------+
|**Pretrained model from milestone 1?**|**Epochs**|**Contrast weight λ**|**Learning Rate**|**Contrast Sampling**|**Temperature**|**Horizon**|**Noise augmentation ?**|**FDE**|**COL-I**|
+----------------------+----------+---------------------+-----------------+---------------------+---------------+-----------+------------------------+-------+---------+
...
+----------------------+----------+---------------------+-----------------+---------------------+---------------+-----------+------------------------+-------+---------+
|     YES-25epochs     |    5     |          12.0       |       5e-4      |         Multi       |      0.1      |      4    |           YES          |  ?.???|  ?.???  |
+----------------------+----------+---------------------+-----------------+---------------------+---------------+-----------+------------------------+-------+---------+
